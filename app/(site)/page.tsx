...
const page = async () => {
  ...
  return (
    <div className="contents-padding pt-0">
      <Category />
      <PlayListCarousel
        playlistArray={dummyPlaylistArr1}
        thumbname={<UserIcon className="w-10 h-10" />}
        title="Goodbye, My Summer"
        subTitle="다시듣기"
      />
      <PlayListCarousel
        playlistArray={dummyPlaylistArr2}
        thumbname={<UserIcon className="w-10 h-10" />}
        title="된장찌개를 좋아해"
        subTitle="새로운 앨범"
      />
      <PlayListCarousel
        playlistArray={dummyPlaylistArr3}
        thumbname={<UserIcon className="w-10 h-10" />}
        title="I want to know"
        subTitle="K-라이징"
      />
      <PlayListCarousel
        playlistArray={dummyPlaylistArr4}
        thumbname={<UserIcon className="w-10 h-10" />}
        title="선샤인코메디클럽 M/V"
        subTitle="NEXT ON"
      />

      ...
      {homeCategoryList.map(item => {
        return (
          <li
            ...
            className={
              cn("flex items-center min-w-fit px-3 py-1.5 borader border-transparent text-xs rounded-lg bg-slate-300/10 hover:bg-slate-300/30 cursor-pointer",
                homeCategory === item.label && "bg-white text-neutral-900 hover:bg-white"
              )
            }>
            {item.label}
          </li>
